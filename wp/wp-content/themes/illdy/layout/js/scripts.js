...
// anirudh added function
$( document ).ready( function() {

        $('input[name="service"]').on( 'click', function( event ) {

            $(".select_btn").removeClass('active'); 

            $("input[name='service']:checked").parent().addClass("active");

        });
        
        // on click of book button.
        $("#login_mobile_btn").on( 'click', function( event ) {
