...
<html <?php language_attributes(); ?>>
  ...
  <?php do_action('maxagency_before_site'); ?>
  	<?php 
	if ( function_exists( 'maxagency_contact_info' ) ) {
		maxagency_contact_info(); 
	}?>
	...
	<?php 
	if ( function_exists( 'maxagency_mobile_header' ) ) {
		//maxagency_mobile_header(); 
	}?>
		...
		<?php if( is_front_page() ) : ?>
			<?php
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					maxagency_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					maxagency_banner_slider();
				else :
					maxagency_banner_background();
				endif;
			?>
		<?php else : ?>
			<div class="other-header">
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() :maxagency_get_breadcrumb() );
						}else{
							maxagency_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
