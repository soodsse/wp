 ...
 * Set import files
 */
function maxagency_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'maxagency-ex'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'maxagency_set_import_files' );

/**
 * Define actions that happen after import
 */
function maxagency_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'maxagency_actions_after_import' );
