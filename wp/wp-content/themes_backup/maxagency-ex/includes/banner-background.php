...
function maxagency_banner_background() {
	
	$title = get_theme_mod('banner_sub_title', __('Delivers more than expected', 'maxagency-ex'));
	$fornt_img = get_theme_mod('banner_side_img','');
	$subtitle = get_theme_mod('banner_main_title', __('Welcome to Maxagency', 'maxagency-ex'));
	$subpera = get_theme_mod('banner_para', __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet ullamcorper erat', 'maxagency-ex'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('Ready to start', 'maxagency-ex'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('Know more', 'maxagency-ex'));
...
function maxagency_banner_video() {
